...
enum pixHawkChannels {
  ...
  throttleIndex = 2,
  sailInputPWMPin = A5,
  rudderInputPWMPin = A6,
  throttleInputPWMPin = A7
};
...
const int experimentPin3 = 3;
const int experimentpin4 = 4;
const int experimentpin5 = 5;
const int experimentpin6 = 6;
const int experimentpin7 = 7;
